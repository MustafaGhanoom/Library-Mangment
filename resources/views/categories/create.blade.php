...
<div class="container">
    ...
    <div class="form-container">
        ...
        <p></p>
        <form class="centered-form" action="{{ route('categories.store') }}" method="POST">
                @csrf
                @if($errors->any())
            ...
            @endif
                <div class="mb-3">
                    ...
                    <input type="name" class="form-control" id="name" name="namecategory">
                </div>
                <div class="mb-3">
                    <label for="descriptioncategory" class="form-label">{{  __ ('messages.category_description') }}</label>
                    <input type="name" class="form-control" id="descriptioncategory" name="descriptioncategory">
                </div>
